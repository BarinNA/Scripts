...
def runTests(basename, path_tests, path_allurereport):
    ...
    path_add = os.path.join("C:\\Program Files (x86)","OneScript","lib", "add")
...
t1 = {'basename': 'reconsiled_base', 'path_tests': 'C:/1C_DATA/Tests/recoins', 'path_allurereport': r'C:\1C_DATA\Allure\for_testing'}
...
#Это делается для корректного формаирования трендов
