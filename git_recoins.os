...
Процедура СобратьКонфигурацию(ИзФайловой)
	
	КаталогФайлов = "C:\1C_DATA\git\recoins";
	КаталогСФ = "C:\1C_DATA\git\recoins\recoins_" + Формат(ТекущаяДата(), "ДФ=dd.MM.yyyy") + ".cf";
...
ИначеЕсли Собрать_CF Тогда
	СобратьКонфигурацию(ИзФайловой);
Иначе
